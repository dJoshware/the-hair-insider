                    ...
                    <div className='space-y-6'>
                        ...
                        <Card className='rounded-3xl'>
                            ...
                            <CardContent className='space-y-3 text-sm'>
                                <ul className='list-disc pl-5 space-y-2'>
                                    <li>
                                        Account information: email address and
                                        basic authentication identifiers used to
                                        sign you in.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        used for security and performance (for
                                        example, IP address, device information,
                                        pages visited).
                                    </li>
                                </ul>
                            </CardContent>
                        ...
                        <Card className='rounded-3xl'>
                            ...
                            <CardContent className='space-y-3 text-sm'>
                                <ul className='list-disc pl-5 space-y-2'>
                                    ...
                                    <li>
                                        To respond to messages and support
                                        requests.
                                    </li>
                                    <li>
                                        To improve the site, troubleshoot, and
                                        keep it secure.
                                    </li>
                                    <li>
                        ...
                        <Card className='rounded-3xl'>
                            ...
                            <CardContent className='space-y-3 text-sm'>
                                <p>
                                    ...
                                    payment processors (for example, Stripe). We
                                    do not store your full payment card details
                                    on our servers. These providers may collect
                                    and process information according to their
                                    own privacy policies.
                                </p>
                                <p>
                                    We may use service providers for hosting,
                                    email delivery, and analytics. We share only
                                    what is reasonably necessary for them to
                        ...
                        <Card className='rounded-3xl'>
                            ...
                            <CardContent className='space-y-3 text-sm'>
                                <p>
                                    ...
                                    for authentication, security, and site
                                    functionality. You can control cookies
                                    through your browser settings. Some features
                                    may not work properly if you disable
                                    cookies.
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className='rounded-3xl'>
                            ...
                            <CardContent className='space-y-3 text-sm'>
                                <p>
                                    ...
                                    needed to provide services, comply with
                        ...
                        <Card className='rounded-3xl'>
                            ...
                            <CardContent className='space-y-3 text-sm'>
                                <ul className='list-disc pl-5 space-y-2'>
                                    <li>
                                        You can request access to, correction
                                        of, or deletion of your data.
                                    </li>
                                    <li>
                                        You can opt out of non-essential
                                        marketing emails if we send them.
                                    </li>
                                    <li>
